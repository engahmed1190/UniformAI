...
const ar: Dict<typeof en> = {
  common: {
    ...
    save: 'حفظ', confirm: 'تأكيد', loading: 'جارٍ التنفيذ…', included: 'مشمول',
  ...
  home: {
    title: 'الرئيسية',
    subtitle: 'كل ما يخص الزي الموحد لفريقك، في مكان واحد.',
    askTitle: 'أي فريق تريد تجهيز زيه؟',
    askSubtitle: 'صف لنا الفريق واحتياجاته وسنساعدك في اختيار الزي المناسب.',
    describeTeam: 'اكتب احتياجاتك',
  ...
  design: {
    ...
    needLabel: 'ما احتياجات فريقك؟',
    needHint: 'اذكر طبيعة عمل الفريق، الموسم، الألوان المطلوبة وأي متطلبات خاصة بالزي.',
    peopleLabel: 'كم عدد الموظفين؟',
    logoLabel: 'نص الشعار',
    logoHint: 'سيظهر على معاينة قطع الزي.',
    generate: 'اقترح لي أطقمًا',
    generating: 'جارٍ تجهيز 3 مقترحات مناسبة…',
  ...
  configure: {
    title: 'تخصيص الطقم',
    subtitle: 'الأسعار المعروضة تقديرية بناءً على كتالوج العرض.',
    nothingYet: 'لا يوجد طقم للتخصيص حتى الآن',
    ...
    coloursNote: 'أنت تعدّل لون {garment}. اختر قطعة أخرى من المعاينة لتعديلها.',
    brandingNote: 'تُحتسب تكلفة الشعار مرة واحدة لكل فرد، بغض النظر عن عدد القطع داخل الطقم.',
    ...
    previewUpdates: 'شاهد التغييرات مباشرة على المعاينة',
    selectGarment: 'اختر قطعة لتغيير لونها',
    standardCloth: 'خامة موحدة',
    mixedGrades: 'خامات متنوعة',
    askTitle: 'أو اكتب التعديلات التي تريدها',
    askNote: 'يمكنك طلب عدة تعديلات معًا. سنوضح لك كل تغيير تم تطبيقه، ولن يتم تعديل أي شيء لم تطلبه.',
    ...
    setsLine: '{price} للفرد · {sets} طقم (يشمل {spare} احتياطي)',
    setsLineNoSpare: '{price} للفرد · {sets} طقم',
  },

  quote: {
    title: 'عرض السعر الخاص بك',
    validFor: 'عرض السعر صالح لمدة 30 يومًا.',
    branding: 'الشعار والتخصيص',
    upgrade: 'إضافة',
    sets: 'الأطقم',
    coversPeople: '{people} موظف + {spare} طقم احتياطي',
    coversNoSpare: '{people} موظف · بدون كمية احتياطية',
    total: 'الإجمالي',
  ...
  orders: {
    ...
    noneNote: 'صمّم طقمًا، خصّص تفاصيله، راجع عرض السعر ثم أكّد الطلب. ستتمكن بعد ذلك من متابعة جميع مراحل الإنتاج من هنا.',
    startOne: 'تصميم زي جديد',
    colOrder: 'الطلب',
    colStatus: 'الحالة',
    colValue: 'القيمة',
    ...
    whatWasMade: 'القطع التي تم تصنيعها',
  ...
  kits: {
    ...
    forPeople: '{price} لعدد {count} موظف',
    saved: 'تم حفظ «{name}» ضمن الأطقم المحفوظة',
    already: '«{name}» محفوظ بالفعل ضمن أطقمك',
  },

  settings: {
    title: 'الإعدادات',
    subtitle: 'احفظ بيانات شركتك ومتطلبات الزي لاستخدامها في كل تصميم جديد.',
    company: 'بيانات الشركة',
    companyNote: 'تظهر بيانات الشركة في عروض الأسعار وتساعدنا في إعداد الطلبات المناسبة لفريقك.',
    companyName: 'اسم الشركة',
    totalStaff: 'عدد الموظفين',
    industry: 'القطاع',
    industryHint: 'يساعدنا القطاع في اقتراح أطقم مناسبة لطبيعة عمل فريقك.',
    dressCode: 'سياسة الزي',
    dressCodeNote: 'تُستخدم هذه المتطلبات عند اقتراح الأطقم، لذلك اكتبها بشكل واضح وبسيط.',
    rulesLabel: 'متطلبات الزي لفريقك',
    language: 'اللغة',
    languageNote: 'تحدد لغة الواجهة والمحتوى الذي يظهر لك.',
    interfaceLanguage: 'لغة الواجهة',
    save: 'حفظ الإعدادات',
    saved: 'تم حفظ الإعدادات',
    nameNeeded: 'اسم الشركة مطلوب لأنه سيظهر في عروض الأسعار.',
    staffNeeded: 'يجب أن يكون عدد الموظفين شخصًا واحدًا على الأقل.',
  ...
  manager: {
    ...
    reasonDefault: 'أقرب الخيارات لما وصفته',
    didColourKept: 'التزمت بالألوان {colour}',
    didColour: 'باللون {colour}',
    didLogo: 'والشعار على {place}',
    didUnbranded: 'بدون شعار',
    whyWithDid: '{did} — {reason}.',
    whyPlain: '{reason}.',
    cheapest: '{name} هو الأوفر بسعر {price} للفرد.',
    fabricPushKnit: 'مع حرارة الصيف تستحق الخامة عالية الأداء فرق الـ90 للفرد.',
    fabricGoodCall: 'اختيار موفق — 90 إضافية للفرد، وسيلاحظ الفريق الفرق مع منتصف اليوم.',
    fabricStandard: 'الخامة القياسية تكفي ما لم تُلبس يوميًا.',
    colourLight: 'الألوان الفاتحة تظهر عليها الأوساخ سريعًا في الموقع — الأفضل إبقاء البنطلون داكنًا.',
    colourDark: 'الداكن يخفي أثر الاستعمال ويتحمل الغسيل. لمسة أفتح واحدة تمنعه من الظهور كزي أمني.',
    brandNone: 'يوفر ما بين 17 و35 للفرد، لكن بلا علامة تفقد القطع طابع الزي الموحد.',
    brandPrint: 'الطباعة توفر 17 للفرد. مناسبة للأقمشة المسطحة، لكنها تبهت مع الغسيل الساخن.',
    brandEmbroidery: 'التطريز أعلى بـ17 للفرد ويدوم أطول من القطعة نفسها — أوفر على مدى سنتين.',
    spareNone: '{sets} طقم بالضبط — الموظف الجديد ينتظر دورة الإنتاج التالية. نسبة 5٪ تأمين رخيص.',
    quoteCovers: 'يغطي {people} موظف بالإضافة إلى {spare} احتياطي. لا يُحتسب شيء قبل تأكيد الطلب — أجمع المقاسات بعده.',
    quoteCoversNoSpare: 'يغطي {people} موظف. لا يُحتسب شيء قبل تأكيد الطلب — أجمع المقاسات بعده.',
    orderDelivered: 'سُلّم في {date}. أخبرني إذا احتاج أي شيء استبدالًا — نفس المواصفات ونفس السعر.',
    orderMaking: '{stage} الآن، والخامات كلها متوفرة. التسليم حوالي {date} — سأخبرك هنا إذا تغير ذلك.',
    orderSizes: 'تم الطلب في {placed}. أجمع المقاسات الآن — يبدأ القص فور اكتمالها، والتسليم حوالي {due}. سأخبرك هنا إذا تغير ذلك.',
    greetNothing: '{part} يا {name}. لا شيء يحتاج إليك اليوم.',
    greetSizes: '{part} يا {name}. تم طلب {kit} — أجمع المقاسات الآن لأمر البيع {id}.',
    greetMaking: '{part} يا {name}. {kit} قيد الإنتاج، والتسليم حوالي {date}.',
    greetMany: '{part} يا {name}. {sizes} بانتظار المقاسات و{making} قيد الإنتاج.',
  ...
  branding: {
    embroidery: 'تطريز',
    print: 'طباعة',
    embroideryNote: 'تطريز متين بمظهر احترافي وراقٍ.',
    printNote: 'خيار اقتصادي ومناسب للشعارات والتصميمات المطبوعة.',
    left_chest: 'يسار الصدر',
    right_chest: 'يمين الصدر',
    sleeve: 'الكم',
    back: 'الظهر',
    none: 'بدون شعار',
    ...
    sleeveNote: 'مكان بسيط وأنيق، مناسب للفرق التي تتعامل مباشرة مع العملاء.',
    backNote: 'يوفر وضوحًا أكبر من مسافة، ومناسب لفرق التشغيل والعمل الميداني.',
    noneNote: 'بدون شعار، ولا توجد تكلفة طباعة أو تطريز.',
    embroideredLogo: 'شعار بالتطريز',
    printedLogo: 'شعار بالطباعة',
  },

  spare: {
    none: 'بدون كمية احتياطية',
    noneNote: 'سيحتاج الموظفون الجدد إلى الانتظار حتى دورة الإنتاج التالية.',
    five: '5% احتياطي',
    ten: '10% احتياطي',
    note: '{count} طقم للموظفين الجدد أو لاستبدال القطع',
    sets: '{count} طقم',
  },

  errors: {
    notUnderstood: 'يمكنك طلب تغيير اللون أو الخامة أو الشعار أو الكمية الاحتياطية. جرّب مثلًا «غيّر البنطلون إلى الكحلي» أو «استخدم خامة مناسبة للعمل الميداني».',
  },
};
